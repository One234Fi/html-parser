...
//                if (s_equal(tag_name, String("html"))) {
//                    //create an element
//                    //  document
//                    //      -> this
...
//                if (s_equal(tag_name, String("head"))
//                    || s_equal(tag_name, String("body"))
//                    || s_equal(tag_name, String("html"))
//                    || s_equal(tag_name, String("br"))) {
//                    //TODO: same as default
//                } else {
//                    //Parse error, ignore
//                }
...
//                string tag_name = *opt_unwrap(&t.start_tag.name, string, &String(""));
//                if (s_equal(tag_name, String("html"))) {
//                    //TODO: process using "in body" insertion mode
//                } else if (s_equal(tag_name, String("head"))) {
...
//                if (s_equal(tag_name, String("html"))) {
//                    //TODO: process using "in body" insertion mode
//                } else if (s_equal(tag_name, String("base"))
//                        || s_equal(tag_name, String("basefont"))
//                        || s_equal(tag_name, String("bgsound"))
//                        || s_equal(tag_name, String("link"))) {
//                    //TODO: insert html element
//                    //pop node stack
//                    //ack self-closing
//                } else if (s_equal(tag_name, String("meta"))) {
//                    //TODO: insert html element
//                    //pop node stack
//                    //ack self-closing
//                    //OTHERWISE do the meta stuff
//                } else if (s_equal(tag_name, String("title"))) {
//                    //RCDATA alg
//                } else if (s_equal(tag_name, String("noscript"))
//                        || s_equal(tag_name, String("noframes"))
//                        || s_equal(tag_name, String("style"))) {
//                    //RAWTEXT alg
//                } else if (s_equal(tag_name, String("script"))) {
//                    //TODO:
//                } else if (s_equal(tag_name, String("template"))) {
//                    //TODO:
//                } else if (s_equal(tag_name, String("head"))) {
//                    //Parse error, ignore
//                } else {
...
//                } else if (s_equal(tag_name, String("body"))
//                    || s_equal(tag_name, String("html"))
//                    || s_equal(tag_name, String("br"))) {
//                    //TODO: same as default
//                } else if (s_equal(tag_name, String("template"))) {
...
//                string tag_name = *opt_unwrap(&t.start_tag.name, string, &String(""));
//                if (s_equal(tag_name, String("html"))) {
//                    //process using "in body" insertion mode
//                } else if (s_equal(tag_name, String("basefont"))
//                        || s_equal(tag_name, String("bgsound"))
//                        || s_equal(tag_name, String("link"))
//                        || s_equal(tag_name, String("meta"))
//                        || s_equal(tag_name, String("noframes"))
//                        || s_equal(tag_name, String("style"))) {
//                    //process using in_head insertion mode
//                } else if (s_equal(tag_name, String("head"))
//                        || s_equal(tag_name, String("noscript"))) {
//                    //parse error, ignore
//                }
//            }
//            break;
...
//            {
//                string tag_name = *opt_unwrap(&t.end_tag.name, string, &String(""));
//                if (s_equal(tag_name, String("noscript"))) {
//                    //pop noscript from stack
//                    p->insert_mode = IN_HEAD;
//                } else if (s_equal(tag_name, String("br"))) {
//                    //TODO: default
//                } else {
//                    //parse error, ignore
//                }
...
//                } else if (s_equal(tag_name, String("frameset"))) { 
//                    //insert elem
...
//                        || s_equal(tag_name, String("meta"))
//                        || s_equal(tag_name, String("noframes"))
//                        || s_equal(tag_name, String("script"))
//                        || s_equal(tag_name, String("style"))
//                        || s_equal(tag_name, String("template"))
//                        || s_equal(tag_name, String("title"))) {
//                    //parse error
//                    //put head->pointer on open elem stack
//                    //process using in_head insert mode
...
//        case END_TAG: 
//                string tag_name = *opt_unwrap(&t.end_tag.name, string, &String(""));
//                if (s_equal(tag_name, String("template"))) {
//                    //process using in_head insert mode
//                } else {
//                    //parse error, ignore
//                }
